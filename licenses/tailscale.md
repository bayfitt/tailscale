...
Some packages may only be included on certain architectures or operating systems.
 ...
 - [github.com/tailscale/systray](https://pkg.go.dev/github.com/tailscale/systray) ([Apache-2.0](https://github.com/tailscale/systray/blob/d0cacc864c78/LICENSE))
 ...
 - [golang.org/x/sync](https://pkg.go.dev/golang.org/x/sync) ([BSD-3-Clause](https://cs.opensource.google/go/x/sync/+/v0.14.0:LICENSE))
 ...
 - [golang.org/x/time/rate](https://pkg.go.dev/golang.org/x/time/rate) ([BSD-3-Clause](https://cs.opensource.google/go/x/time/+/v0.11.0:LICENSE))
